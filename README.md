...
- отдельное распределение призовых мест: `~3000 ₽`, `~1500 ₽` и `~500 ₽`;
...
- видит участников на 1-м, 2-м и 3-м местах и соответствующие призы;
...
7. Нажмите кубок у победителя либо перетащите игрока в подходящий следующий
   матч.
8. Изменения сохраняются на сервере автоматически и становятся видны
   гостям.
